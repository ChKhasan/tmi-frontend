  ...
  <Teleport to="body">
    ...
    >
      <Transition name="modal" mode="out-in">
        <div
          v-if="show"
          class="bg-white-200 w-full lg:max-w-[920px] shadow-xl relative max-h-screen md:overflow-y-auto rounded-2xl"
        ...
        >
          ...
          >
            <slot name="header">
              ...
              >
                <span
                  class="icon-x text-sm text-gray-100 group-hover:text-red transition-300"
                />
              </button>
            </slot>
          </div>
